    ...
    <form class="border border-success rounded p-3 mx-auto mb-3" style="max-width: 700px; margin-top: 100px;"
      ...
      <div class="row">
        ...
        <div class="col-md-6 mb-2">
          ...
          <input name="nome" class="form-control form-control-sm" id="nome" maxlength="95">
        ...
        <div class="col-md-6 mb-2">
          ...
          <input name="tipoRemedio" class="form-control form-control-sm" id="tipoRemedio" maxlength="15">
          <p class="text-danger small mb-0 erros"></p>
        </div>
        ...
        <div class="col-md-6 mb-2">
          ...
          <input name="restricao" class="form-control form-control-sm" id="restricao" maxlength="245">
          <p class="text-danger small mb-0 erros"></p>
        </div>
        ...
        <div class="col-md-6 mb-2">
          ...
          <input name="contraIndicacoes" class="form-control form-control-sm" id="contraIndicacoes" maxlength="1995">
          <p class="text-danger small mb-0 erros"></p>
        </div>
        ...
        <div class="col-md-6 mb-2">
          ...
          <input name="efeitos" class="form-control form-control-sm" id="efeitos" maxlength="995">
          <p class="text-danger small mb-0 erros"></p>
        </div>
        ...
        <div class="col-md-6 mb-2">
          ...
          <input name="substancia" class="form-control form-control-sm" id="substancia" maxlength="195">
          <p class="text-danger small mb-0 erros"></p>
        </div>
        ...
        <div class="col-md-6 mb-2">
          ...
          <input name="substancia_tipo" class="form-control form-control-sm" id="substancia_tipo" maxlength="95">
          <p class="text-danger small mb-0 erros"></p>
        </div>
        <div class="col-md-6 mb-2">
        ...
        <div class="col-md-6 mb-2">
          ...
          <input name="validade" class="form-control form-control-sm" id="validade" maxlength="245" placeholder="em meses ou anos">
          <p class="text-danger small mb-0 erros"></p>
        </div>
        ...
        <div class="col-md-6 mb-2">
          ...
          <input name="conservacao" class="form-control form-control-sm" id="conservacao"
            maxlength="95" placeholder="Ex: Local seco e refrigerado">
          <p class="text-danger small mb-0 erros"></p>
        </div>
